...
<div class="maindiv">
	...
	<div class="rightdiv">
		  ...
		  <form action="combo offers1.php" method="post" enctype="multipart/form-data">
		  
		  <p style="margin-top:-80px;"><a style="text-decoration:none;color:#FFFFFF;" href="fetchcombo.php">edit</a></p><br/><b/>
	      ...
	      Sub menu&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="menutype">
						 ...
						 <option value="1">combo offers</option>
