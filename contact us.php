...
<body>
    ...
    <div class="contact">
        ...
        <div class="contact1">
            ...
            <div class="container-fluid" style="width: 100%;">
                ...
                <div class="mapouter">
                    <div class="gmap_canvas"><iframe width="600" height="400" id="gmap_canvas"
                            src="https://maps.google.com/maps?q=1%20rue%20de%20paris%2Cparis&t=&z=15&ie=UTF8&iwloc=&output=embed"
            ...
            <p style="margin-left:100px; font-family:Vladimir Script; font-size:23px;margin-top:10px;">Guesto
                Coffee.<br />
                Rue de Paris<br />
        ...
        <div class="contact2">
            ...
            <form action="../contact1.php" method="get">
                ...
                <input class="d" type="submit" value="Submit"
                    style="background:#E4D8C2; height:35px; width:120px; border-radius:10px;" />
        </div>
